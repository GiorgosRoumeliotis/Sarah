...
#include <memory>
#include "../Sarah/qdynamicbutton.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDynamicButton_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QDynamicButton_t qt_meta_stringdata_QDynamicButton = {
    {
QT_MOC_LITERAL(0, 0, 14) // "QDynamicButton"
...
static const uint qt_meta_data_QDynamicButton[] = {
...
QT_INIT_METAOBJECT const QMetaObject QDynamicButton::staticMetaObject = { {
    QMetaObject::SuperData::link<QPushButton::staticMetaObject>(),
    qt_meta_stringdata_QDynamicButton.data,
